...
func NewHelloAPIAPI(spec *loads.Document) *HelloAPIAPI {
	return &HelloAPIAPI{
		...
		GetAPIReportHandler: GetAPIReportHandlerFunc(func(params GetAPIReportParams) middleware.Responder {
			return middleware.NotImplemented("operation GetAPIReport has not yet been implemented")
		}),
...
type HelloAPIAPI struct {
	...
	// GetAPIReportHandler sets the operation handler for the get API report operation
	GetAPIReportHandler GetAPIReportHandler
...
func (o *HelloAPIAPI) Validate() error {
	...
	if o.GetAPIReportHandler == nil {
		unregistered = append(unregistered, "GetAPIReportHandler")
	}
...
func (o *HelloAPIAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/api/report"] = NewGetAPIReport(o.context, o.GetAPIReportHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	...
	o.handlers["GET"]["/alive"] = NewCheckHealth(o.context, o.CheckHealthHandler)
}
