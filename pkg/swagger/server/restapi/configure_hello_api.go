...
//go:generate swagger generate server --target ../../server --name HelloAPI --spec ../../api.yaml --principal interface{} --exclude-main
...
func configureAPI(api *operations.HelloAPIAPI) http.Handler {
	...
	if api.GetAPIReportHandler == nil {
		api.GetAPIReportHandler = operations.GetAPIReportHandlerFunc(func(params operations.GetAPIReportParams) middleware.Responder {
			return middleware.NotImplemented("operation operations.GetAPIReport has not yet been implemented")
		})
	}
